...
public class ASelectAuthorizationFilter implements Filter, ASelectConstants {
    ...
    private boolean isUserError(String code) {
        return ASELECT_AGENT_TICKET_UNKNOWN.equals(code)
            || ASELECT_AGENT_TICKET_EXPIRED.equals(code)
            || ASELECT_AGENT_TICKET_INVALID.equals(code)
            || ASELECT_AGENT_AUTHSESSION_EXPIRED.equals(code);
    }
